      ...
      <div className="glass-panel" style={{ flex: 1, position: "relative", zIndex: 3, display: "flex", alignItems: "center", justifyContent: "center", padding: "clamp(24px, 6vw, 64px)", overflowY: "auto" }}>
        <div className="mobile-safe" style={{ width: "100%", maxWidth: 440 }}>
          ...
          <div className="animate-5" style={{ marginBottom: 12 }}>
            ...
            <div className={`input-wrap${passFocus ? " focused" : ""}`}>
              ...
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.3)", padding: "0 18px", display: "flex", alignItems: "center", minWidth: 48, minHeight: 48, justifyContent: "center" }}
          ...
          <p className="animate-7" style={{ fontFamily: "var(--font-sans)", fontSize: "clamp(11px, 1.5vw, 12px)", color: "rgba(255,255,255,0.4)", marginTop: "clamp(20px, 3vh, 28px)", lineHeight: 1.6, textAlign: "center" }}>
            ...
            and{" "}
            <a href="/privacy" style={{ color: "rgba(0,212,182,0.8)", textDecoration: "none" }}>Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
