  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex h-[100dvh] w-[100dvw] gap-x-2 overflow-hidden",
          className,
        )}
        {...props}
      >
        <div className="bg-zinc-950 shadow-small flex hidden h-full w-[344px] shrink-0 flex-col items-start gap-y-8 px-8 py-6 lg:flex relative">
          {onClose && (
            <Button
              className="absolute top-6 right-6 bg-zinc-900 text-small text-zinc-400 font-medium border border-zinc-800 px-4"
              radius="full"
              variant="flat"
              onPress={onClose}
            >
          ...
          <div>
            ...
            <div className="text-default-500 mt-1 text-base leading-6 font-medium">
              List your product in a few steps
            </div>
          </div>
          {/* Desktop Steps */}
          <VerticalSteps
            ...
            steps={[
              {
                ...
                description: "Name, category and images",
              },
              {
              ...
              },
              {
                ...
                description: "Price and stock levels",
              },
              {
                title: "Review & List",
        ...
        <div className="flex h-full w-full flex-col items-center gap-4 md:p-4 bg-zinc-900">
          ...
          <div className="h-full w-full p-4 sm:max-w-md md:max-w-lg">
            ...
            <MultistepNavigationButtons
              ...
              className="lg:hidden"
              nextButtonProps={{
                children: currentPage === 3 ? "Create Product" : "Continue",
              }}
              onBack={onBack}
              onNext={onNext}
            />
