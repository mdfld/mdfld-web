		...
		<div ref={ref} {...props}>
			<div className="sm:border-default-200 lg:border-l-small xl:border-r-small w-full flex-col">
				...
				<div className="flex w-full overflow-visible ">
					<ScrollShadow className="flex max-h-[calc(100dvh-240px)] flex-col gap-6 px-6 py-4 lg:max-h-[calc(100dvh-190px)]">
				...
				<div className="mx-2 my-2 py-4 mt-auto flex flex-col">
					<MessagingChatInput />
				</div>
			</div>
		</div>
