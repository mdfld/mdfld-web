...
import OrganizationListingsLayout from "@/components/dashboard/organizations/listings/app";
      ...
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          <p className="text-gray-600">
            You don't have permission to access organization listings
          </p>
        </div>
      </div>
    );
